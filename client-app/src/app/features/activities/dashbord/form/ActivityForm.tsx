...
export default function ActivityForm({ selectedActivity, onCloseForm, createOrEditActivity }: Props) {
    ...
    return (
        <Segment clearing>
            <Form onSubmit={onSubmit}>
                ...
                <Form.Input placeholder="Date" name="date" value={activity.date} onChange={onInput} />
